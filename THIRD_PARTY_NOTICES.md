...
Иконки не входят в репозиторий и в сборки. Агент скачивает их по ID из галереи LaMetric по запросу пользователя, для личного использования. Права на иконки принадлежат их авторам и LaMetric.
...
<details><summary><b>MIT OR Apache-2.0 OR Zlib</b> — 4</summary>

lru-slab 0.1.3, raw-window-handle 0.6.2, zune-core 0.5.3, zune-jpeg 0.5.15
